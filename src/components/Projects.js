                ...
                <div className="tile is-ancestor">
                  <div className="tile is-4 is-parent  is-vertical">
                    { 
                      ...
                      ? this.state.projects.map(project => <Project name={project.projectname} id={project.id} key={project.id} />)
                      : <div className="tile notification is-warning">No projects available</div>
                    }
                  </div>
                </div>
              </div>

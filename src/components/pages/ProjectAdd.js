                ...
                <form onSubmit={event => this.handleAddProject(this.state.newproject.id, event)}>
                  <div className="field has-addons">
                    <div className="control">
                      <input className="input is-medium" type="text" placeholder="Project Name" value={this.state.newproject.projectname} onChange={this.onAddProjectNameChange} />
                    </div>
                    <div className="control">
                      <input className="input is-medium" type="text" placeholder="Enter id" value={this.state.newproject.id} onChange={this.onAddProjectIdChange} />
                    </div>
                    <div className="control">
                ...
                <div className="tile is-ancestor">
                  <div className="tile is-4 is-parent  is-vertical">
                    {this.state.projects.map((project, index) => (
                      <Project isAdd={true} handleUpdateProject={this.handleUpdateProject} handleDeleteProject={this.handleDeleteProject} name={project.projectname} id={project.id} key={project.id} />
                    ))}
                  </div>
                </div>
              </div>
